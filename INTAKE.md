...
Incomplete uploads are deleted after one day. Submitted records and both image copies are deleted after 90 days. Emails remain in the recipient mailbox. The retention job runs every five minutes in bounded batches.
...
For release checks, submit a test batch and verify the email includes the full assessment and all numbered photos. No customer decision/reply is sent automatically. Use the existing GitHub/Cloudflare release process and preserve unrelated site edits.
